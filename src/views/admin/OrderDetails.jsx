        ...
        >
          ...
          <div className="mt-4">
            ...
            {seller.products.map((product) => (
              <div
                key={product.id}
                className="flex items-center bg-gray-50 p-4 rounded-lg mb-3 shadow-md hover:shadow-lg transition duration-200 border border-gray-200"
              >
                <img
                  src={product.image}
                  alt={product.name}
